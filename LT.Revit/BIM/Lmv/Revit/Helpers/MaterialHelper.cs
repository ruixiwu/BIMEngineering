namespace BIM.Lmv.Revit.Helpers
{
    ...
    internal class MaterialHelper
    {
        ...
        public MaterialHelper(IDataExport exporter, ExportTarget target, bool includeTexture, View3D view)
        {
            if (exporter == null)
            {
        ...
        public int OnMaterial(Document document, MaterialNode node)
        {
            ...
            {
                return this._Exporter.OnMaterial(key, null);
            }
            MaterialInfo materialInfo = this.GetMaterialInfo(node);
            int num = this._Exporter.OnMaterial(key, materialInfo);
        ...
        public int OnMaterialForRPC()
        {
            ...
            int num = this._Exporter.OnMaterial(key, material);
            this._Keys.Add(key, num);
            return num;
        }
        ...
        private class DigestDiffuseColor : MaterialHelper.DigestProperties
        {
