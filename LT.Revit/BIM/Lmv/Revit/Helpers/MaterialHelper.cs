...
namespace BIM.Lmv.Revit.Helpers
{
    internal class MaterialHelper
    {
        ...
        public int OnMaterial(Document document, MaterialNode node)
        {
            ...
            {
                return _Exporter.OnMaterial(key, null);
            }
            var materialInfo = GetMaterialInfo(node);
            var num = _Exporter.OnMaterial(key, materialInfo);
            _Keys.Add(key, num);
            return num;
        }
        ...
        public int OnMaterialForRPC()
        {
            ...
            var num = _Exporter.OnMaterial(key, material);
            _Keys.Add(key, num);
            return num;
        }
