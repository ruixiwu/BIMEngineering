...
namespace BIM.Lmv.Revit.Utility
{
    internal class WinApi
    {
        ...
        [DllImport("user32.dll")]
        public static extern IntPtr FindWindowEx(IntPtr hWnd, IntPtr hWndChildAfter, string windowClass,
            string windowName);
        ...
        [DllImport("user32.dll")]
        public static extern uint SendInput(uint nInputs, [In, MarshalAs(UnmanagedType.LPArray)] INPUT[] pInputs,
            int cbSize);
