namespace BIM.Lmv.Revit.License.Standard
{
    ...
    internal class BitAnswerX86 : BitAnswerInterface
    {
        ...
        public const string BitAnswerDllName = "00002e81_00000001";
        private uint handle;
        ...
        [DllImport("00002e81_00000001")]
        private static extern int Bit_DecryptFeature(uint handle, uint featureId, byte[] cipherBuffer, byte[] plainBuffer, uint bufferLen);
        [DllImport("00002e81_00000001")]
        ...
        [DllImport("00002e81_00000001")]
        private static extern int Bit_SetProxy(byte[] applicationData, string host, uint port, string userId, string password);
        [DllImport("00002e81_00000001")]
