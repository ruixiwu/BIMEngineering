...
namespace BIM.Lmv.Revit.Batch
{
    internal class RevitDialogResponse
    {
        ...
        {
            var dictionary = new Dictionary<RevitDialogType, string>
            {
                {
        ...
        {
            return _Overrides.ContainsKey(dialogId);
        }
    }
}