namespace BIM.Lmv.Types
{
    public class PropDef
    {
        ...
        public static PropDef DefInstanceof = new PropDef("instanceof_objid", "__instanceof__", PropDataType.Ref, null,
            true);

        public static PropDef DefIsDocument = new PropDef("is_doc_property", "__document__", PropDataType.Boolean, null,
            true);
        ...
        public static PropDef DefSchemaVersion = new PropDef("schema_version", "__document__", PropDataType.String, null,
            true);

        public static PropDef DefViewableIn = new PropDef("viewable_in", "__viewable_in__", PropDataType.String, null,
            true);

        public static PropDef DefXrefId = new PropDef("xref", "__externalref__", PropDataType.String, null, true);

        public static PropDef[] PredefList =
        {
            DefName, DefChild, DefParent, DefInstanceof, DefHastable, DefViewableIn,
            DefXrefId, DefIsDocument, DefSchemaName, DefSchemaVersion, DefHyperlink, DefCategory
        };
